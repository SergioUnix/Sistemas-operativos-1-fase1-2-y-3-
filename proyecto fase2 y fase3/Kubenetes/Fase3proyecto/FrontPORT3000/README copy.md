...
--crear imagen para fronted
  docker build -t sergiounix/front_fase3_react_graficas .

  --publicar en docker hub la imagen creada
   docker push sergiounix/front_fase3_react_graficas



-- crear contenedor para la imagen 
  docker run -d -p 80:80 --name frontfase1 sergiounix/front_fase3_react_graficas
  docker run -d -p 8080:8080 --name frontfase1 sergiounix/front_fase3_react_graficas
